...
<html>
    ...
    <body id="dt_example">
        ...
        <div>
            <center><a href="inicio3.jsp">Diccionario Columnas <span class="glyphicon glyphicon-globe"></span></a></center>
        </div>
        <div class="container">
            ...
            <div>
                <div class="col-lg-12">
                    <div class="responsive-tables">
                        ...
                        <a href="ReporteGeneral.jsp" class="btn btn-success"><span class="glyphicon glyphicon-save-file"></span> Export to Excel</a>
                    </div>
                </div>
            </div>
